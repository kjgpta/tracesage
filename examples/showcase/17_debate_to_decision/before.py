"""17 — Debate-to-Decision (plain LangGraph).

Two personas — an optimist and a skeptic — argue a proposal across 2 rounds. A round
counter in state drives a conditional edge that loops the debate, then a judge node reads
the transcript and renders a verdict. Pattern: multi-persona loop with a bounded counter.
