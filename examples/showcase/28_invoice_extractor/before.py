"""28 — Invoice / Expense Extractor (plain LangChain).

Extracts a structured Invoice (vendor, date, line items, total) from messy invoice
text using `llm.with_structured_output(Invoice)`, then validates that the line-item
amounts sum to the stated total and prints PASS / FAIL. Pattern: structured output +
business-rule validation — the bread-and-butter of accounts-payable automation.
