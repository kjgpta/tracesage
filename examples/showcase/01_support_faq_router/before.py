"""01 — Support FAQ Router (plain LangChain).

Classifies an inbound support question, then routes it to the matching answer chain
(billing / technical / account) or an escalation path. Pattern: classify-then-branch
with RunnableBranch — a tiny but extremely common production shape.
