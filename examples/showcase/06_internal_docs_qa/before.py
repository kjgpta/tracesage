"""06 — Internal Docs Q&A (plain LangChain).

RAG over a tiny self-contained product FAQ: build a local Chroma store from ~5
hardcoded Documents, retrieve the top-k chunks for a question, stuff them into a
prompt, and answer WITH citations. Pattern: retrieve-then-answer (the canonical
production RAG shape).
