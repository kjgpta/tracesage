...
tracelens ships a gallery of **runnable** examples in the
[`examples/`](https://github.com/kjgpta/tracelens/tree/main/examples) directory,
in three tiers — from a 30-second first taste to a 30-app before/after gallery.

| Tier | Folder | Needs | What it is |
|---|---|---|---|
| **Getting started** | [`examples/getting_started/`](https://github.com/kjgpta/tracelens/tree/main/examples/getting_started) | no API key | 3 standalone demos driven by `FakeListChatModel` — run instantly |
| **MCP tools** | [`examples/mcp/`](https://github.com/kjgpta/tracelens/tree/main/examples/mcp) | `tracelens[mcp]` | tools from local MCP servers attributed by source, plus hardcoded tools |
| **Showcase** | [`examples/showcase/`](https://github.com/kjgpta/tracelens/tree/main/examples/showcase) | an LLM API key | **30 real before/after apps** across popular use cases |
